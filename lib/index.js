...
function startVimspector() {
    return __awaiter(this, arguments, void 0, function* () {
        ...
        const config = coc_nvim_1.workspace.getConfiguration('java.debug');
        const profile = config.get('vimspector.profile');
        const adapterPort = config.get('vimspector.substitution.adapterPort');
        const overrides = getOverrides(arguments);
        const settings = Object.assign({ configuration: profile, [adapterPort]: debugPort }, overrides);
